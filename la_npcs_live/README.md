...
### Description
Living NPCs NPCs is a FiveM resource that enables players to interact with custom non-playable characters (NPCs) by pressing the E key. This documentation provides instructions on how to create and implement interactable NPCs in your client or server resource.

#### Why Use Living NPCs NPCs?
Living NPCs NPCs offers the following advantages:
